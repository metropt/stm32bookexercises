...
static const struct ST7735_cmdBuf initializers[] = {
  ...
  // FRMCTR1, FRMCTR2 Frame Rate configuration -- Normal mode, idle
  // frame rate = fosc / (1 x 2 + 40) * (LINE + 2C + 2D) 
  { 0xB1, 10, 3, { 0x01, 0x06, 0x03 }},
  // Memory access directions. row address/col address, bottom to top refesh (10.1.27)
  { ST7735_MADCTL,  0, 1, {MADVAL(MADCTLGRAPHICS)}},
  // Display settings #5, 2 args, no delay
  { ST7735_DISSET5,  0, 2, {0x15, 0x02}},
  // INVCTR Display inversion (no inversion)
  { 0xB4,  0, 1, { 0x00 }},
  // PWCTR1 Power control -4.6V, Auto mode
  { 0xC0,  10, 3, { 0x02, 0x70}},
  ...
  //VMCTR1 Power control
  { 0xC5,  10, 2, { 0x3c, 0x38 }},
  // PWCTR6 Power control, opamp current smal, boost frequency
  { 0xFC,  0, 2, { 0x11, 0x15 }},
  // GMCTRP1 Gamma correction
  { 0xE0, 0, 16, {0x09, 0x16, 0x09, 0x20, 0x21, 0x1b, 0x13, 0x19,
			    0x17, 0x15, 0x1e, 0x2b, 0x04, 0x05, 0x02, 0x0e }},
  // GMCTRP2 Gamma Polarity corrction
  { 0xE1, 0, 16, {0x0b, 0x14, 0x08, 0x1e, 0x22, 0x1d, 0x18, 0x1e,
...
void ST7735_init() 
{
  ...
  //pins as output and speed at 50Mhz
